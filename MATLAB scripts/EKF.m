...
% r12=-psi_dot*s_psi*s_phi*s_theta + phi_dot*c_psi*c_phi*s_theta+theta_dot*c_psi*s_phi*c_theta + phi_dot*s_phi*s_psi-psi_dot*c_phi*c_psi;
...
% r23=-phi_dot*s_phi*s_psi*s_theta + psi_dot*c_phi*c_psi*s_theta + theta_dot*c_phi*s_psi*c_theta + psi_dot*s_psi*s_phi - phi_dot*c_psi*c_phi;
% r31=-theta_dot*c_theta;
% r32=-theta_dot*s_theta*s_phi+phi_dot*c_theta*c_phi;
% r33=-phi_dot*s_phi*c_theta-theta_dot*c_phi*s_theta;
% J1_dot=[r11 r12 r13; r21 r22 r23; r31 r32 r33];
% Test=simplify(J1_dot*J1');
% 
% w=simplify([Test(3, 2); Test(1, 3); Test(2, 1)]);
% transf=[c_psi*c_theta -s_psi 0; c_theta*s_psi c_psi 0; -s_theta 0 1];
% w=transf*eta2_dot;
%% Eq di Navigazione
...
%Eq alle differenze
x1_upd=x1 + T*x3;
x2_upd=x2 + T*J2*u2 + T*J2*w_gyro;
x3_upd=(eye(3) + T*J1*skew_product(u2+w_gyro)*(J1'))*x3 + T*J1*(u1+w_acc);
