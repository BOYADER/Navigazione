...
int main(int argc, char **argv)
{
	...
	while(ros::ok())
	{
		...
		loop_rate.sleep();
       	...
       	ROS_WARN("Test\n");
		Vector3f test_pos(1, 2, 3);
		Vector3f test_rpy(M_PI/5, M_PI/7, M_PI/3);
		Vector3f test_ni1(4, 5, 6);
		...
		/*cout << usbl_obj.function(test_pos, test_rpy) << endl;
		cout << usbl_obj.get_H(test_pos, test_rpy) << endl;
		cout << usbl_obj.get_M() << endl;*/

		cout << vileMatriceF(test_rpy, test_ni1) << "\n" << endl;
		//cout << Jacobian_RPY(test_rpy) << endl;
	}
